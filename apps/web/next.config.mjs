...
// إن جاء بدون بروتوكول (مثل host من Render) نُضيف https تلقائياً.
let API_INTERNAL_URL = process.env.API_INTERNAL_URL ?? 'http://localhost:4000';
if (!/^https?:\/\//.test(API_INTERNAL_URL)) {
