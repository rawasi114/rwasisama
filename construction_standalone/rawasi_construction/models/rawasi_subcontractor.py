...
class RawasiSubcontractor(models.Model):
    ...
    code = fields.Char(string="الرمز", default="/", readonly=True, copy=False, index=True)
    ...
    attachment_ids = fields.Many2many(
        ...
        "subcontractor_id", "attachment_id",
        string="المرفقات",
    )
